...
- 🔭 Currently working as **Full-Stack Developer** at **Pixel Perfects Solutions**
...
#### 🏢 [Pixel Perfects Admin Portal](https://portal.pxlperfects.com)
Enterprise-level admin portal for managing clients, staff, and administrators with complete CRUD operations.
- **Tech:** React.js, Node.js, Express.js, MongoDB, Tailwind CSS
- **Features:** Role-based access control, RESTful APIs, JWT authentication

#### 🎨 [ColorFact AI](https://colorfact.fr)
AI-powered outfit suggestion platform with personalized style recommendations.
- **Tech:** React.js, Next.js, AI Integration, Node.js, MongoDB
- **Features:** AI style matching, Admin portal, CRUD operations

#### 💼 [Dotera](https://dotera.co)
Modern, responsive business platform with pixel-perfect design.
- **Tech:** React.js, Next.js, Tailwind CSS
- **Features:** Cross-browser compatibility, Mobile-first design

#### 📅 Capture This One
Booking platform with Google Calendar integration for seamless appointment scheduling.
- **Tech:** React.js, Next.js, Google Calendar API
- **Features:** Real-time availability, Booking confirmation system
